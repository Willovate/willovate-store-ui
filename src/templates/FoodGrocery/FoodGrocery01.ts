...
export const FoodGrocery01: TemplateConfig = {
  ...
  sections: [
    ...
    { id: 's4', type: 'category-grid', props: { title: 'Aisles', categories: [{ name: 'Produce', image: 'https://images.unsplash.com/photo-1610832958506-aa56368176cf?auto=format&fit=crop&q=80&w=600' }, { name: 'Dairy', image: 'https://images.unsplash.com/photo-1628085448375-7389a9f02930?auto=format&fit=crop&q=80&w=600' }, { name: 'Bakery', image: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?auto=format&fit=crop&q=80&w=600' }, { name: 'Meat', image: 'https://images.unsplash.com/photo-1607623814075-e51df1bdc82f?auto=format&fit=crop&q=80&w=600' }] } },
    ...
    { id: 's6', type: 'catalog', props: {
      products: [
        ...
        { id: 'fg01-3', name: 'Sourdough Loaf', description: 'Freshly baked', price: 4.99, imageUrl: 'https://images.unsplash.com/photo-1589367920969-ab8e050bfc19?auto=format&fit=crop&q=80&w=600', category: 'Bakery', stockQuantity: 100, visualTheme: 'default', isFeatured: false, slug: 'sourdough-loaf', compareAtPrice: null },
        { id: 'fg01-4', name: 'Ground Beef', description: '1lb pack', price: 6.99, imageUrl: 'https://images.unsplash.com/photo-1588169930714-866e13f4841b?auto=format&fit=crop&q=80&w=600', category: 'Meat', stockQuantity: 100, visualTheme: 'default', isFeatured: false, slug: 'ground-beef', compareAtPrice: null }
      ]
    }},
