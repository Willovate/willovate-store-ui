...
export const FoodGrocery03: TemplateConfig = {
  ...
  sections: [
    ...
    { id: 's3', type: 'category-grid', props: { title: '', categories: [{ name: 'Grains', image: 'https://images.unsplash.com/photo-1621939514649-280e2ee25f60?auto=format&fit=crop&q=80&w=600' }, { name: 'Canned', image: 'https://images.unsplash.com/photo-1563636619-e9143da7973b?auto=format&fit=crop&q=80&w=600' }, { name: 'Spices', image: 'https://images.unsplash.com/photo-1596040033229-a9821ebd058d?auto=format&fit=crop&q=80&w=600' }] } },
    { id: 's4', type: 'catalog', props: {
      products: [
        { id: 'fg03-1', name: 'White Rice', description: '5kg Bag', price: 12.00, imageUrl: 'https://images.unsplash.com/photo-1621939514649-280e2ee25f60?auto=format&fit=crop&q=80&w=600', category: 'Grains', stockQuantity: 200, visualTheme: 'default', isFeatured: false, slug: 'white-rice', compareAtPrice: null },
        { id: 'fg03-2', name: 'Black Beans', description: 'Canned, 15oz', price: 1.50, imageUrl: 'https://images.unsplash.com/photo-1471193945509-9ad0617afabf?auto=format&fit=crop&q=80&w=600', category: 'Canned', stockQuantity: 500, visualTheme: 'default', isFeatured: false, slug: 'black-beans', compareAtPrice: null }
      ]
    }},
