...
export const FoodGrocery08: TemplateConfig = {
  ...
  sections: [
    ...
    { id: 's4', type: 'editorial-grid', props: { title: 'Trending', images: ['https://images.unsplash.com/photo-1610832958506-aa56368176cf?auto=format&fit=crop&q=80&w=600', 'https://images.unsplash.com/photo-1610832958506-aa56368176cf?auto=format&fit=crop&q=80&w=600', 'https://images.unsplash.com/photo-1505253758473-96b7015fcd40?auto=format&fit=crop&q=80&w=600'] } },
    { id: 's5', type: 'catalog', props: {
      products: [
        { id: 'fg08-1', name: 'Neon Energy', description: 'Zero Sugar', price: 3.99, imageUrl: 'https://images.unsplash.com/photo-1610832958506-aa56368176cf?auto=format&fit=crop&q=80&w=600', category: 'Beverage', stockQuantity: 200, visualTheme: 'default', isFeatured: true, slug: 'neon-energy', compareAtPrice: null },
