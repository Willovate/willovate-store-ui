...
export const FoodGrocery02: TemplateConfig = {
  ...
  thumbnailUrl: 'https://images.unsplash.com/photo-1595856453615-5ce82d5a8df2?auto=format&fit=crop&q=80&w=800',
  previewImages: [
    'https://images.unsplash.com/photo-1595856453615-5ce82d5a8df2?auto=format&fit=crop&q=80&w=1600'
  ],
  isFeatured: false,
  theme: {
  ...
  sections: [
    ...
    { id: 's2', type: 'full-hero', props: { title: 'From the Soil', subtitle: 'Organic, farm-fresh produce delivered to your door.', image: 'https://images.unsplash.com/photo-1505934333218-8fe9d924151b?auto=format&fit=crop&q=80&w=1600', ctaLabel: 'Explore' } },
    ...
    { id: 's6', type: 'bento-grid', props: { title: 'Meet the Makers', items: [{ title: 'Valley Farms', description: 'Regenerative agriculture since 1995.', size: 'large', image: 'https://images.unsplash.com/photo-1595856453615-5ce82d5a8df2?auto=format&fit=crop&q=80&w=600' }] } },
    { id: 's7', type: 'catalog', props: {
      products: [
        ...
        { id: 'fg02-2', name: 'Local Honey', description: 'Raw and unfiltered', price: 12.00, imageUrl: 'https://images.unsplash.com/photo-1587049352847-4d4b1263d915?auto=format&fit=crop&q=80&w=600', category: 'Pantry', stockQuantity: 20, visualTheme: 'default', isFeatured: false, slug: 'local-honey', compareAtPrice: null }
      ]
    }},
