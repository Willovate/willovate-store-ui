...
export const FoodGrocery10: TemplateConfig = {
  ...
  sections: [
    ...
    { id: 's4', type: 'editorial-grid', props: { title: 'The Italian Kitchen', images: ['https://images.unsplash.com/photo-1414235077428-338989a2e8c0?auto=format&fit=crop&q=80&w=600', 'https://images.unsplash.com/photo-1509440159596-0249088772ff?auto=format&fit=crop&q=80&w=600'] } },
    { id: 's5', type: 'catalog', props: {
      products: [
        { id: 'fg10-1', name: 'Aged Balsamic', description: '25 Years, Modena', price: 85.00, imageUrl: 'https://images.unsplash.com/photo-1505253758473-96b7015fcd40?auto=format&fit=crop&q=80&w=600', category: 'Pantry', stockQuantity: 20, visualTheme: 'default', isFeatured: true, slug: 'aged-balsamic', compareAtPrice: null },
        { id: 'fg10-2', name: 'Artisan Pasta', description: 'Bronze Die Extruded', price: 18.00, imageUrl: 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?auto=format&fit=crop&q=80&w=600', category: 'Pantry', stockQuantity: 50, visualTheme: 'default', isFeatured: false, slug: 'artisan-pasta', compareAtPrice: null }
      ]
    }},
